...
Your data contract is the heart of your application. It lives at [`prisma/schema.ts`](prisma/schema.ts) and describes your models:
...
| File | Purpose |
|---|---|
| [`prisma/schema.ts`](prisma/schema.ts) | Your data contract — define your models here |
...
1. Edit [`prisma/schema.ts`](prisma/schema.ts) to add or change models.
